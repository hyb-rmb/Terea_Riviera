...
lib.ssMetadata = [
		{name:"Terea_Riviera_atlas_1", frames: [[0,0,686,684],[831,732,62,20],[688,0,324,459],[589,686,240,70],[898,552,76,80],[823,461,144,89],[589,758,245,5],[831,634,97,96],[0,686,587,330],[688,461,133,109],[688,572,208,60],[688,634,94,47]]}
];
...
(lib.bg = function() {
	this.initialize(ss["Terea_Riviera_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({regY:-341.9,scaleX:1.0495,scaleY:1.0495,y:-331.65},59).to({regY:-342,scaleX:1,scaleY:1,y:-342},60).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-360,-690.7,720,717.9000000000001);
...
if (reversed == null) { reversed = false; }
	...
	var instance_11Filter_1 = new cjs.ColorFilter(0,0,0,1,35,220,236,0);
	this.instance_11.filters = [instance_11Filter_1];
	this.instance_11.cache(-362,-693,724,722);

	this.timeline.addTween(cjs.Tween.get(this.instance_11).to({regX:0,regY:-342,scaleX:1,scaleY:1,x:160,y:230},9).wait(66));
	this.timeline.addTween(cjs.Tween.get(instance_11Filter_1).to(new cjs.ColorFilter(1,1,1,1,0,0,0,0), 9).wait(66));

	this.filterCacheList = [];
	this.filterCacheList.push({instance: this.instance_11, startFrame:1, endFrame:9, x:-362, y:-693, w:724, h:722});
	this.filterCacheList.push({instance: this.instance_11, startFrame:0, endFrame:0, x:-362, y:-693, w:724, h:722});
	this.filterCacheList.push({instance: this.instance_11, startFrame:9, endFrame:75, x:-362, y:-693, w:724, h:722});
	this._renderFirstFrame();
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/Terea_Riviera_atlas_1.png?1768232533183", id:"Terea_Riviera_atlas_1"}
	],
	preloads: []
};
